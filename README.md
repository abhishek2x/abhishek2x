...
- **Backend & AI Agents:** Building multi-agent **RAG systems** using **LangGraph**, **LangChain**, and **Elasticsearch**.
- **Quantitative Finance:** Mathematical modeling, **Stochastic Calculus**, and the mechanics of **Options, Futures, and Derivatives**.
- **High-Performance Python:** Optimizing financial risk pipelines and **SIMM** calculations using **multiprocessing** and **ProcessPoolExecutor**.
- **Market Mechanics:** Deep dives into **Bayesian foundations**, probability theory, and **CFA Level 1** financial ethics.
- **Automated Trading & Risk:** Developing scalable architectures at **JPMorgan Chase** to track and manage client-impacting trades.
